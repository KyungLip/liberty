    ...
    private static OkHttpClient initOkHttpClient() {
        ...
        okBuilder.addInterceptor(new Interceptor() {
            ...
            public okhttp3.Response intercept(Chain chain) throws IOException {
                ...
                Log.d(TAG, "请求的URL:" + url + ":" + request.url().toString());
...
//        }
    ...
    public static <T> T post(String url, Map<String, String> params, Class<T> t) throws RemoteException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException, JSONException, KeyStoreException, IOException {
